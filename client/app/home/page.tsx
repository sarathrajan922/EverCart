...
const Home: React.FC = () => {
  ...
  return (
    <>
      <HomeNavBar />
      <main className="flex min-h-screen items-center justify-around  bg-gray-100">
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-2xl hover:shadow-none ">
          ...
          <div className="p-5">
            ...
            <a
              href="#"
              className="flex justify-center  px-3 py-2 text-sm font-medium text-center text-white bg-sky-600 rounded-lg hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-sky-600 dark:hover:bg-sky-500 dark:focus:ring-sky-800"
            >
              Read more
            </a>
          </div>
